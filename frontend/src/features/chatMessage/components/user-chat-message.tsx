...
export function UserChatMessage({ userMessageData }: { userMessageData: UserMessage }) {
    const deleteMutation = deleteUserMessageMutation({ conversationId: userMessageData.conversation });
        ...
        <div className="mb-2">
            <div className='flex justify-end'>
                <Card className="w-fit flex flex-col">
                    {
                        (userMessageData.image) ? ImageExpandModal({ imagePath: userMessageData.image }) : null
                    }
                    <div>
            ...
            <div className='flex justify-end'>
                <Flex gap="0" align="center">
                    <DeleteMessageModal messageId={userMessageData.id} deleteMutation={deleteMutation} />
                </Flex>
            </div>
        </div>
    );
