            ...
            <div className={`${expanded ? 'overflow-y-scroll no-scrollbar' : 'hidden'
                ...
                <div className="flex justify-between items-center mx-2 mt-2">
                    ...
                    <Tooltip content="New Model" side="right">
                        <Button variant='ghost' className="ml-2 p-2" onClick={async () => handleNewModel()}>
                            <PlusIcon />
                        </Button>
                    </Tooltip>
                </div>
                    ...
                    <div className="flex flex-col justify-center align-top">
                        <div className="flex flex-col w-full">
                            <div>
                                ...
                                {isLoading ? <ModelListLoading /> : <ModelList models={models} selectedModelId={selectedModelId} handleSetSelected={handleSetSelected}/>}
                            </div>
                        </div>
                    </div>
                </div>
